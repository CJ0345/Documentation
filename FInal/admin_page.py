...
class AdminPage(ctk.CTk):
    ...
    def show_orders(self):
        ...
        columns = ["Order ID", "Product Name","Size","Name", "Address", "Contact Number","Quantity", "Delivery Date", "Delivery Time", "Total Price"]
    ...
    def print_order(self, tree):
        ...
        order_details = f"""
            ...
            Contact Number:{order_data[5]}
            Quantity: {order_data[6]}
            Delivery Date: {order_data[7]}
            Delivery Time: {order_data[8]}
            Total Price: {order_data[9]}
            """  
        try:
            ...
            close_button = ctk.CTkButton(window, text="Print", command=window.destroy)
